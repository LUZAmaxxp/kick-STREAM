            ...
            >
              ...
              <a
                ...
                className={`
                  ...
                  ${plan.ctaStyle === 'border'      ? 'border border-border text-cream/80 hover:text-cream hover:bg-black/50' : ''}
                  ${plan.ctaStyle === 'solid-green' ? 'bg-accent text-black hover:bg-accent/90' : ''}
