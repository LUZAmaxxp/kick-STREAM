...
const styles = {
  ...
  grid: {
    ...
    backgroundImage: `linear-gradient(rgba(170,255,69,0.03) 1px, transparent 1px),
      linear-gradient(90deg, rgba(170,255,69,0.03) 1px, transparent 1px)`,
  ...
  corner: {
    position: 'absolute',
    width: 20, height: 20,
    borderTop: '1.5px solid rgba(170,255,69,0.3)',
    borderLeft: '1.5px solid rgba(170,255,69,0.3)',
    display: 'block',
  },
  card: {
    width: '100%',
  ...
  prompt: {
    color: '#AAFF45', fontSize: 13,
    marginRight: 8, userSelect: 'none',
  },
  input: {
    flex: 1, background: 'transparent',
    border: 'none', outline: 'none',
    color: '#F2F0E8', fontSize: 13,
    padding: '10px 0',
    fontFamily: "'JetBrains Mono', monospace",
  },
  errorBox: {
  ...
  btn: (loading) => ({
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    padding: '12px 0',
    background: loading ? '#4d7320' : '#AAFF45',
    color: '#08080A',
